...
export default function App() {
  ...
  return (
    <div className={cn(
      ...
      {isOffline && (
        <div className="fixed top-20 left-0 right-0 z-40 bg-red-950/95 border-b border-red-500/20 text-center py-2.5 text-xs font-bold uppercase tracking-widest text-red-400">
      ...
      {sidebarOpen && (
        <>
          ...
          {/* Sidebar panel */}
          <div
            className="fixed top-0 right-0 h-full w-80 bg-[#0a0a0a] border-l border-white/5 z-50 p-8 shadow-2xl flex flex-col justify-between overflow-y-auto animate-slide-in-right"
          >
            {/* Header */}
