...
export function BottomNav({ activeView, onViewChange }: BottomNavProps) {
  ...
  return (
    <nav className={cn(
      "fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-md z-50 border-t h-20 pb-safe px-2 flex justify-around items-center transition-colors duration-300",
